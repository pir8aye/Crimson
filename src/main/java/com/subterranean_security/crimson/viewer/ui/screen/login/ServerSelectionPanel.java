...
import com.subterranean_security.crimson.proto.core.net.sequences.Login.RQ_ServerInfo;
...
public class ServerSelectionPanel extends JPanel {
	...
	private boolean makeConnection() {
		...
		connection = ConnectionThread.makeConnection(new ExecutorFactory(ViewerExecutor.class), server, port, false);
		if (connection == null) {
