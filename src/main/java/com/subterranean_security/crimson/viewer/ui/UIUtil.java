...
public final class UIUtil {
	...
	public static List<Image> getAppIcons() {
		...
		icons.add(Toolkit.getDefaultToolkit().getImage(
				UIUtil.class.getResource("/com/subterranean_security/crimson/core/res/image/app_icon/c-128.png")));
		icons.add(Toolkit.getDefaultToolkit().getImage(
				UIUtil.class.getResource("/com/subterranean_security/crimson/core/res/image/app_icon/c-64.png")));
		icons.add(Toolkit.getDefaultToolkit().getImage(
				UIUtil.class.getResource("/com/subterranean_security/crimson/core/res/image/app_icon/c-32.png")));
		icons.add(Toolkit.getDefaultToolkit().getImage(
				UIUtil.class.getResource("/com/subterranean_security/crimson/core/res/image/app_icon/c-16.png")));
		return icons;
	}
	...
	public static ImageIcon getIcon(String rpath) {
		if (!cache.containsKey(rpath)) {
			ImageIcon icon = getIcon(
					UIUtil.class.getResource("/com/subterranean_security/crimson/viewer/res/image/" + rpath));
			if (icon != null) {
