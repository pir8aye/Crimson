...
public class EditUser extends JPanel {
	...
	public void init() {
		...
		panel.add(lblRetype);
		{
			...
			chckbxGenerator.setSelected(original.getPermissions().getFlag(Perm.server.generator.generate_jar));
						...
						new SwingWorker<Outcome, Void>() {
							...
							protected Outcome doInBackground() throws Exception {
								...
								vp.setFlag(Perm.Super, chckbxSuperuser.isSelected())
										...
										.setFlag(Perm.server.users.view, chckbxViewUsers.isSelected())
