...
public class HostListHeaders extends JPanel {
	...
	public HostListHeaders() {
		...
		chckbxCountry.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxLanguage.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxCrimsonVersion.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxTimezone.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxHostname.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxUsername.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxInternalIp.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxExternalIp.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxOsName.setFont(new Font("Dialog", Font.BOLD, 10));
		static_panel.add(chckbxOsName, gbc_chckbxNewCheckBox);
		chckbxRamCapacity.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxMonitorCount.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxOSFamily.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxVirtualization.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxJavaVersion.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxOSArch.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxCvid.setFont(new Font("Dialog", Font.BOLD, 10));
		static_panel.add(chckbxCvid, gbc_chckbxCvid);
		chckbxCpuModel.setFont(new Font("Dialog", Font.BOLD, 10));
		...
		chckbxMessagePing.setFont(new Font("Dialog", Font.BOLD, 10));

		dynamic_panel.add(chckbxMessagePing);
		chckbxUserStatus.setFont(new Font("Dialog", Font.BOLD, 10));
		dynamic_panel.add(chckbxUserStatus);
		chckbxRamUsage.setFont(new Font("Dialog", Font.BOLD, 10));
		dynamic_panel.add(chckbxRamUsage);
		chckbxCpuTemp.setFont(new Font("Dialog", Font.BOLD, 10));
		dynamic_panel.add(chckbxCpuTemp);
		chckbxCpuUsage.setFont(new Font("Dialog", Font.BOLD, 10));
		dynamic_panel.add(chckbxCpuUsage);
		chckbxActiveWindow.setFont(new Font("Dialog", Font.BOLD, 10));
		dynamic_panel.add(chckbxActiveWindow);
		chckbxScreenPreview.setFont(new Font("Dialog", Font.BOLD, 10));
